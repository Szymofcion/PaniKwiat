...
> = {
    ...
    en: {
        ...
        nav: {
            ...
            links: [
                { href: "/#skomponuj", label: "Create decor", sub: "Design your set" },
                { href: "/#dekoracje", label: "Ready now", sub: "ready pieces" },
                { href: "/cennik", label: "Pricing", sub: "check prices" },
                { href: "/#kimjestem", label: "About me", sub: "let's meet" },
                { href: "/#opinie", label: "Reviews", sub: "what clients say" },
    ...
    de: {
        ...
        nav: {
            ...
            links: [
                { href: "/#skomponuj", label: "Deko planen", sub: "Fantasie frei" },
                { href: "/#dekoracje", label: "Sofort fertig", sub: "fertige Produkte" },
                { href: "/cennik", label: "Preisliste", sub: "Preise prüfen" },
                { href: "/#kimjestem", label: "Über mich", sub: "kennenlernen" },
                { href: "/#opinie", label: "Meinungen", sub: "Stimmen" },
